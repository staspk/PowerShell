...
function RebaseFinish() {
    Write-Host
    PrintDarkRed "RebaseFinish() temporarily disabled."
    PrintRed "`$global:stashed_on_rebase: $global:stashed_on_rebase"
    PrintDarkRed "git push --force will have to be done manually."
    return;
